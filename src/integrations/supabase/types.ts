    ...
    Tables: {
      expenses: {
        Row: {
          ...
          created_at: string
          essential_obligation: boolean | null
          has_legal_link: boolean | null
          id: string
          intention: Database["public"]["Enums"]["expense_intention"]
          name: string
          notice_days: number | null
          override_reason: string | null
          override_rigidity: string | null
          recurrence: string | null
          substitutability: number | null
          updated_at: string
          user_id: string
          warnings: Json | null
        }
      ...
      profiles: {
        Row: {
          ...
          income_is_variable: boolean | null
          updated_at: string
          user_id: string
        }
        Insert: {
